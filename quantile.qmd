...
= & \beta_{q0}+\beta_{q1}age_i+\beta_{q2}otchr_i+\beta_{q3}suppins_i+\beta_{q4}female_i+\beta_{q5}white_i
\end{aligned}
$$

## 3 分位数回归模型的估计：Equation Estimation对话框
...
![](img/fig15_4.png){fig-align="4center"}
...
![](img/fig15_5.png){fig-align="4center"}

## 5 分位数回归模型的可视化：过程系数操作步骤

![](img/fig15_6.png){fig-align="4center"}

## 5 分位数回归模型的可视化：age过程系数图像

![](img/fig15_7.png){fig-align="4center"}

## 5 分位数回归模型的可视化：totchr过程系数图像

![](img/fig15_8.png){fig-align="4center"}
...
https://space.bilibili.com/590872906
